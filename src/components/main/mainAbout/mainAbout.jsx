...
export const MainAbout = () =>
  <section className='main-about'>
    <div className='section-wraper main-about__wrap'>
      <img className='main-about__image' src={mainImages.mainAboutImage} alt="" />
      <div className='main-about__description'>
        <h2 className='caption main-about__caption'>Наш Ресторан</h2>
        ...
        <Link to='/about' className='main-about__button'><div className='main-about__button-caption'>Как заказть</div></Link>
      </div>
    </div>
  </section>